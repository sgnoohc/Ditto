...
namespace Ditto
{
  ...
  namespace CombUtil
  {
    ...
    bool MinDRPair(ObjUtil::Jets& jets);
    ...
    bool GetPair(std::vector<I>& cand0s, std::vector<O>& cand1s, I& p0, O& p1, std::function<float(ObjUtil::Particle, ObjUtil::Particle)> comparator, PAIRCRITERION mode, float critical_x = -999)
    {
      ...
      switch (mode)
      {
        ...
        default:
          PrintUtil::error(TString::Format("CombUtil::GetPair() Not a recognized PAIRCRITERION value", mode)); break;
      }
          ...
          if (&cand0 != &cand1)
          {
            ...
            switch (mode)
            {
              ...
              case AWAYFROMX:
                ...
                break;
              default:
                PrintUtil::error(TString::Format("CombUtil::GetPair() Not a recognized PAIRCRITERION value", mode));
                break;
            }
          }
        }
